...
Cypress.Commands.add('cleanupPessoa', (cnpjCpf) => {
  return cy.task('db:exec', {
    sql: `        
      ...
      WHERE idOperacao IN (SELECT id FROM MC_MOP_OPERACAO WHERE idCedente IN (SELECT id FROM MC_CED_CEDENTE WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf)));
      
      DELETE FROM MC_MOP_ENTIDADE_ARQUIVO WHERE idCedente IN (SELECT id FROM MC_CED_CEDENTE WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf)); 
      ...
      DELETE FROM MC_MOP_ASSINATURA_DIGITAL_SACADO WHERE idOperacaoTitulo in (SELECT id FROM MC_MOP_OPERACAO_TITULO WHERE idSacado IN (SELECT id FROM MC_CAD_SACADO WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf)));
      ...
      DELETE FROM MC_MOP_ASSINATURA_DIGITAL_SACADO WHERE idOperacaoTitulo in (SELECT id FROM MC_MOP_OPERACAO_TITULO WHERE idOperacao IN (SELECT id FROM MC_MOP_OPERACAO WHERE idCedente IN (SELECT id FROM MC_CED_CEDENTE WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf))));
      DELETE FROM MC_MOP_ASSINATURA_DIGITAL_SACADO WHERE idOperacao in (SELECT id FROM MC_MOP_OPERACAO WHERE idCedente IN (SELECT id FROM MC_CED_CEDENTE WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf)));
      ...
      DELETE FROM MC_MOP_MONITORAMENTO_NFE      WHERE idOperacaotitulo in (SELECT id FROM MC_MOP_OPERACAO_TITULO WHERE idSacado IN (SELECT id FROM MC_CAD_SACADO WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf)));
      DELETE FROM MC_MOP_TITULOS                WHERE idSacado IN (SELECT id FROM MC_CAD_SACADO WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf));
      DELETE FROM MC_MOP_OPERACAO_TITULO        WHERE idSacado IN (SELECT id FROM MC_CAD_SACADO WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf));
      DELETE FROM MC_CAD_SACADO                 WHERE idPessoa IN (SELECT id FROM MC_CAD_PESSOA WHERE cnpjCpf=@cnpjCpf);
